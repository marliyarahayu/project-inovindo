...
class ProfilController extends Controller
{
    ...
    public function profil(){
        ...
        return view('inputprofil')->with($data);
    }
    ...
    //         'logo' => 'mimes:jpg,png,jpeg,gif','max:10000',
    //         'website' => $request ->website,
    //         'email' => $request ->email,
    //         'password' => bcrypt($request->password)
    //     ]);
    //     $cre = $request->file('logo')->store('image');  
    //     if($cre){
    //         return "success";
    //     }
    //     Institusi::create($validatedData);
    //     return redirect('editprofil')->with('Succsess','Data sudah diisi');
    // }
    public function store(Request $request){
        $validatedData = $request->validate([
            ...
            $cre = Institusi::create($validatedData);
            return redirect('/input/edit/'.$cre->id)->with('Succsess','Data sudah diisi');
